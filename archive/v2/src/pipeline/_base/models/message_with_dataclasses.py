...
@dataclass(frozen=True, slots=True, kw_only=True)
class BaseFrameJobInProgressMessage(BaseMessage, ABC):
    """
...
@dataclass(frozen=True, slots=True, kw_only=True)
class BaseIngestionDroppedItemMessage(ABC):
    details: str

@dataclass(frozen=True, slots=True, kw_only=True)
class BaseDroppedJobMessage(ABC):
    """
...
@dataclass(frozen=True, slots=True, kw_only=True)
class BaseCriticalErrorMessage(ABC):
    details: str
