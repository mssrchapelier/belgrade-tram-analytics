...
from src.v1_2.pipeline._mock._base.service.worker_server.adapters.mq.output_to_mq.to_asyncio_queue import MockWorkerServerAsyncioOutputAdapter

# between the pipeline stage and workers // for the worker, output

class SummatorWorkerMockMQBrokerOutputAdapter(MockWorkerServerAsyncioOutputAdapter):
