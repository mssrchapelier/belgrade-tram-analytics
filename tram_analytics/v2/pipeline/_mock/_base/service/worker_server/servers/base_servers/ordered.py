...
from tram_analytics.v2.pipeline._base.worker_servers.ordered_worker_server import BaseOrderedWorkerServer
...
class OrderedWorkerServer[
    InputT, OutputT, ConfigT: BaseWorkerServerConfig
](
    BaseOrderedWorkerServer[
